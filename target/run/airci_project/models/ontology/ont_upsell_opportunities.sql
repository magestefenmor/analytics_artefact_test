    ...
    create  table
      "dev"."main_ontology"."ont_upsell_opportunities__dbt_tmp"
...
WITH customer_booking_profile AS (
    ...
    FROM "dev"."main_marts"."fact_bookings"     b
    LEFT JOIN "dev"."main_marts"."fact_flights" f ON f.flight_id = b.flight_id
...
customer_base AS (
    ...
    LEFT JOIN "dev"."main_marts"."dim_customers" c ON c.customer_id = p.customer_id
),
